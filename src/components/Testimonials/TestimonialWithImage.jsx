  ...
  return (
    <div className="border-4 pt-28 bg-white lg:bg-inherit lg:py-24 relative">
      <div className="bg-blue-800">
        <div className="text-white px-4 lg:px-10 lg:ml-114">
          <img
            className="absolute max-h-52 w-xs rounded-xl top-0 object-cover object-[50%_25%] left-1/2 -translate-x-1/2 lg:max-h-full lg:w-full lg:max-w-sm lg:left-65 lg:top-1/2 lg:-translate-y-1/2"
            src={image}
            alt={`${name} testimonial`}
          />
          <div className="pt-40 pb-16 lg:py-20 px-8 max-w-xs lg:max-w-3xl">
